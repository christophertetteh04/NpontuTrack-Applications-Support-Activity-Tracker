    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-5 py-3">
                    <p class="font-medium text-gray-900 text-sm"><?php echo e($user->designation ?: ucfirst(str_replace('_', ' ', $user->role))); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e($user->department); ?></p>
                </td>
                <td class="px-5 py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/imac/Projects/NpontuTrack-Applications-Support-Activity-Tracker/resources/views/users/index.blade.php ENDPATH**/ ?>